...
| ---------------------- | ---------------- | ---------------- | --------------------- |
| `check_palindrome_1`   |8.18 msec per loop|5.96 msec per loop|81.8 msec per loop|
| `check_palindrome_2`   |4.97 msec per loop|4.38 msec per loop|7.06 msec per loop|
